...
<c:if test = "${auth_response != 'Credit card order did not processed successfully!' && auth_response != 'Credit card order processed successfully!'}">
  <div class="customer-info-container">
      ...
      <ul>
          ...
          <li></li>
          <li>Card Num: ${myCart.customerInfo.cardnum}</li>
          <li>Card Name: ${myCart.customerInfo.cardname}</li>
          <li>Expire: ${myCart.customerInfo.expire}</li>
          <li>Code: ${myCart.customerInfo.code}</li>
      </ul>
      <h3>Cart Summary:</h3>
      <ul>
  ...
  <h2 style="color:green">${auth_response}</h2>
